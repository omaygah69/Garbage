...
window.onscroll = () => {
  if (window.scrollY > 0) {
    ...
    jimmyEatAllThePizza.style.backdropFilter = "blur(32px)";
    jimmyEatAllThePizza.style.filter = "saturate(120%) brightness(110%)";
    jimmyEatAllThePizza.style.backgroundImage = "none";
    // jimmyEatAllThePizza.style.mixBlendMode = "luminosity";
  } else {
    jimmyEatAllThePizza.style.backgroundImage =
      "linear-gradient(to bottom, #000000dd, transparent)";
    jimmyEatAllThePizza.style.backgroundColor = "transparent";
